...
const chartMap = {
  ...
  serial_tx_control: { label: "Serial TX Control", color: "#97c1ff" },
  serial_tx_fire: { label: "Serial TX Fire", color: "#ff7070" },
  serial_tx_status: { label: "Serial TX Status", color: "#ff70a6" },
  serial_tx_yaw: { label: "Serial TX Yaw (rad)", color: "#648fff" },
  serial_tx_pitch: { label: "Serial TX Pitch (rad)", color: "#dc267f" },
  serial_tx_distance: { label: "Serial TX Distance (m)", color: "#fe6100" },
  serial_tx_yaw_vel: { label: "Serial TX Yaw Vel (rad/s)", color: "#785ef0" },
  serial_tx_pitch_vel: { label: "Serial TX Pitch Vel (rad/s)", color: "#ffb000" },
  serial_tx_yaw_acc: { label: "Serial TX Yaw Acc (rad/s²)", color: "#00bfa0" },
  serial_tx_pitch_acc: { label: "Serial TX Pitch Acc (rad/s²)", color: "#f95d6a" },
  serial_rx_roll: { label: "Serial RX Roll (rad)", color: "#7ac74f" },
  serial_rx_mode: { label: "Serial RX Mode", color: "#a0a0ff" },
  serial_rx_pitch: { label: "Serial RX Pitch (rad)", color: "#4ecdc4" },
  serial_rx_yaw: { label: "Serial RX Yaw (rad)", color: "#6c5ce7" },
